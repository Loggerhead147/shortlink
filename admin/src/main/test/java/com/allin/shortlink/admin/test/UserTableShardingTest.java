package src.main.test.java.com.allin.shortlink.admin.test;

public class UserTableShardingTest {
//    public static final String SQL = "CREATE TABLE `t_user_%d` (\n" +
//            "  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',\n" +
//            "  `username` varchar(256) DEFAULT NULL UNIQUE COMMENT '用户名',\n" +
...
//            ") ENGINE=InnoDB AUTO_INCREMENT=1802617874663886850 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;";
    ...
    public static final String SQL = "CREATE TABLE `t_group_%d` (\n" +
            ...
            ") ENGINE=InnoDB AUTO_INCREMENT=1800455194297585667 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;";
