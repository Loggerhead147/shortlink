...
import static com.allin.shortlink.admin.common.constant.RedisCacheConstant.LOCK_USER_REGISTER_KEY;
import static com.allin.shortlink.admin.common.enums.UserErrorCodeEnum.USER_NAME_EXIST;
import static com.allin.shortlink.admin.common.enums.UserErrorCodeEnum.USER_SAVE_ERROR;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, UserDO> implements UserService {
    ...
    public UserLoginRespDTO login(UserLoginReqDTO requestParam) {
        ...
        // TODO 为方便测试，这里Token过期时间设置为30天，后续应根据实际业务需求更改
